package vn.hoanguyen.compose.onlinestore.components.phonetextfield.data
...
enum class CountryData(val countryIso: Iso31661alpha2, val countryPhoneCode: PhoneCode) {
    ...
    companion object {
        ...
        internal val phoneCodeMap: Map<PhoneCode, CountryData> =
            entries.associateBy { it.countryPhoneCode }
    }
}